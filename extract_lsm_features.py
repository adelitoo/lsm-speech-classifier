...
FEATURE_SETS = {
    'all': ['spike_counts', 'spike_variances', 'mean_spike_times', 'first_spike_times', 'last_spike_times', 'mean_isi', 'isi_variances', 'burst_counts'],
    ...
    'original': ['spike_counts', 'spike_variances', 'mean_spike_times', 'mean_isi', 'isi_variances']
}
...
if __name__ == "__main__":
    ...
    parser.add_argument("--feature-set", type=str, default="all", choices=FEATURE_SETS.keys(),
                        help="The set of features to extract (default: all).")
